...
public class DoadorNewMoveisFragment extends Fragment {

    Button btnEnviarMoveis;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnEnviarMoveis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController.navigate(R.id.action_newMoveisFragment_to_doacaoConcluidaFragment);
            }
        });
